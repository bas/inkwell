...
1. Ingest research handoff and restate assumptions. Expect the handoff to follow the `inkwell-research` output contract: Research question, Scope & assumptions, Requirements lock, Evidence traceability, Options & tradeoffs, Recommendation, Open decisions & owners, Plan-ready backlog, and Handoff to plan.
